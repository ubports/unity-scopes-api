...
Categories (\see Category) are displayed in the order their results are pushed - this usually poses a challenge for aggreagor scopes,
...
many cases it may be neccessary to derive from BufferedResultForwarder and reimplement unity::scopes::utility::BufferedResultForwarder::push(unity::scopes::CategorisedResult).
...
the unity::scopes::SearchReplyProxy reply proxy returned by unity::scopes::utility::BufferedResultForwarder::upstream() (note, that this is a different proxy
...
calling unity::scopes::utility::BufferedResultForwarder::set_ready() as soon as it knows it won't push results for any new categories. In typical cases, where

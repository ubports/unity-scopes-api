...
ActivationBase::UPtr ScopeBase::activate_preview_action(Result const& /* result */, VariantMap const& /* hints */, std::string const& /* widget_id */, std::string const& /* action_id */)
{
    return ActivationBase::UPtr(new ActivationBase()); // default impl returns NotHandled
}

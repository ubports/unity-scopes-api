...
This widget support all the attributes of rating-input widget, plus three
extra attributes (review, rating, author) to pre-fill the widget with data of an existing review.
